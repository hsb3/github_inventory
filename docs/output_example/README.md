...
This automated report provides a comprehensive analysis of GitHub repositories and starred projects. Data is collected using the GitHub CLI and includes repository metadata, activity metrics, and language statistics.

## Methodology & Notes

- **Data Source:** GitHub REST API v4 via GitHub CLI
- **Repository Sizes:** Displayed in MB (converted from KB)
- **Sorting:** Owned repositories by last update date, starred by star count
- **Indicators:** 🗄️ = archived, (fork) = forked repository
- **Limitations:** Tables show most relevant entries; full data available in CSV exports
...
**Top Languages:** JavaScript: 33 | TypeScript: 6 | Astro: 1 | Swift: 1 | Python: 1

| Name | Description | Visibility | Language | Size (MB) | Branches | Updated |
|------|-------------|------------|----------|-----------|----------|----------|
| [sindresorhus.github.com](https://github.com/sindresorhus/sindresorhus.github.com) | Personal website of Sindre Sorhus | public | Astro | 66.2 | 1 | 2025-08-23 |
| [string-width](https://github.com/sindresorhus/string-width) | Get the visual width of a string - the number o... | public | JavaScript | <0.1 | 1 | 2025-08-23 |
| [p-retry](https://github.com/sindresorhus/p-retry) | Retry a promise-returning or async function | public | JavaScript | <0.1 | 1 | 2025-08-23 |
| [ky](https://github.com/sindresorhus/ky) | 🌳 Tiny & elegant JavaScript HTTP client based o... | public | TypeScript | 1.0 | 1 | 2025-08-23 |
| [p-limit](https://github.com/sindresorhus/p-limit) | Run multiple promise-returning & async function... | public | JavaScript | <0.1 | 1 | 2025-08-23 |
| [pretty-bytes](https://github.com/sindresorhus/pretty-bytes) | Convert bytes to a human readable string: 1337 ... | public | JavaScript | <0.1 | 1 | 2025-08-23 |
| [eslint-plugin-unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) | More than 100 powerful ESLint rules | public | JavaScript | 6.0 | 2 | 2025-08-23 |
| [type-fest](https://github.com/sindresorhus/type-fest) | A collection of essential TypeScript types | public | TypeScript | 2.2 | 2 | 2025-08-23 |
| [got](https://github.com/sindresorhus/got) | 🌐 Human-friendly and powerful HTTP request libr... | public | TypeScript | 3.0 | 2 | 2025-08-23 |
| [open](https://github.com/sindresorhus/open) | Open stuff like URLs, files, executables. Cross... | public | JavaScript | 0.2 | 1 | 2025-08-23 |
| [awesome](https://github.com/sindresorhus/awesome) | 😎 Awesome lists about all kinds of interesting ... | public |  | 1.5 | 2 | 2025-08-23 |
| [yn](https://github.com/sindresorhus/yn) | Parse yes/no like values | public | JavaScript | <0.1 | 1 | 2025-08-22 |
| [uint8array-extras](https://github.com/sindresorhus/uint8array-extras) | Useful utilities for working with Uint8Array (a... | public | JavaScript | <0.1 | 1 | 2025-08-22 |
| [p-throttle](https://github.com/sindresorhus/p-throttle) | Throttle promise-returning & async functions | public | JavaScript | <0.1 | 1 | 2025-08-22 |
| [electron-context-menu](https://github.com/sindresorhus/electron-context-menu) | Context menu for your Electron app | public | JavaScript | 0.3 | 1 | 2025-08-22 |
| [awesome-whisper](https://github.com/sindresorhus/awesome-whisper) | 🔊 Awesome list for Whisper — an open-source AI-... | public |  | 1.2 | 1 | 2025-08-22 |
| [execa](https://github.com/sindresorhus/execa) | Process execution for humans | public | JavaScript | 2.5 | 1 | 2025-08-22 |
| [tsconfig](https://github.com/sindresorhus/tsconfig) | Shared TypeScript config for my projects | public |  | <0.1 | 1 | 2025-08-22 |
| [fast-cli](https://github.com/sindresorhus/fast-cli) | Test your download and upload speed using fast.com | public | TypeScript | 1.4 | 1 | 2025-08-22 |
...
| [sketch-icon-preview](https://github.com/sindresorhus/sketch-icon-preview) | sindresorhus | Sketch plugin to preview macOS app icons in the Dock usin... | JavaScript | 49 | 1 | 2025-07-31 |
