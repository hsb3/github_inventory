...
from .inventory import collect_owned_repositories, collect_starred_repositories, write_to_csv
        ...
        with open(config_path, 'r', encoding='utf-8') as f:
            if config_path.suffix.lower() in ['.yml', '.yaml']:
                try:
                    ...
                    raise ImportError("PyYAML is required to read YAML config files. Install with: uv add pyyaml")
            else:
                data = json.load(f)
